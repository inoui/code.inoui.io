      ...
      for (var i = 0; i < files.length; i++) {
        ...
        if (acceptedTypes[file.type] === true) {
          ...
          xhr.onload = function (e) {
            ...
            var jsonResponse = JSON.parse(e.currentTarget.response);
            console.log(jsonResponse);

            $('.progress:first').before('<span class="mediumImages-image"><img src="'+ jsonResponse.filelink +'" draggable="true"></span>');
