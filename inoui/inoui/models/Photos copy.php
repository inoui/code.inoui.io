...
class Photos extends \lithium\core\StaticObject {
    ...
    public static function generate($slug, $type, $crop, $w = null, $h = null) {
        ...
        $file = LITHIUM_APP_PATH . "/webroot/media/{$slug}";
        ...
        $destination = "{$thumbs}.{$width}{$crop}{$height}.{$type}";
        // die($destination);
...
//            return false;
        ...
        self::image_gd_resize($source, $destination, $width, $height, $endWidth, $endHeight);
    }
