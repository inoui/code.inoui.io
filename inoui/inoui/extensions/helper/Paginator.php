...
class Paginator extends \lithium\template\Helper {
	...
	protected $_strings = array(
		'pagingWrapper'	=> '<ul class="{:class}">{:content}</ul>'
	);
	...
	protected function _init() {
		...
		$this->_page = isset($this->_context->_config['data']['page']) ? ($this->_context->_config['data']['page'] + 0) : 1;
		$this->_total = isset($this->_context->_config['data']['total']) ? $this->_context->_config['data']['total'] : 1;
		$this->_limit = isset($this->_context->_config['data']['limit']) ? $this->_context->_config['data']['limit'] : 1;
	}
	...
	public function paginate(array $options = array()) {
		...
		return $this->_render(__METHOD__, 'pagingWrapper', compact('content', 'class'), array('escape' => false));
	}
